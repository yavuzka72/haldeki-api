...
public function dealer(Request $request)
{
    ...
    $orders = \App\Models\Order::query()
        ...
        ->select([
            ...
            'orders.user_id',
            'orders.dealer_id',
            'orders.partner_client_id', // ✅ bunu da seçelim
            'orders.status',
            'orders.dealer_status',
            'orders.supplier_status',
            'orders.payment_status',
            ...
            DB::raw('pc.lat     as partner_client_lat'),
            DB::raw('pc.long    as partner_client_long'),
        ])
        ->with([
            'items' => function ($q) {
...
public function vendor(Request $request)
{
    ...
    // 🔎 EN SADE HÂLİ: Sadece user_id ile siparişleri çek
