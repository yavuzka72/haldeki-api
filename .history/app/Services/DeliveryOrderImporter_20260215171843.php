 ...
 public function importByOrder(Order $o, array $overrides = []): DeliveryOrder
{
    ...
    private function mapOrderToDeliveryRow(Order $o, int $clientId = 0): array
    {
        ...
        $buyerName  = $o->ad_soyad ;  ///optional($buyer)->name ?: 'Müşteri';
...
*/
    ...
    ? $o->partnerClient
    : ($o->partner_client_id ? $o->partnerClient()->select('id','name','address','phone','latitude','longitude','city','district')->first() : null);
        ...
        $delivery = [
            'name'          => $pc?->ad_soyad ?? $o->ad_soyad ?? 'Müşteri',
            'address'       => $buyerAddr,
