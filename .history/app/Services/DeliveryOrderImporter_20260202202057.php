...
*/
            ...
            $pickupName  = $pc?->name ?: ($dealerName ?: 'Depo');
            $pickupAddr  = $pc?->address ?: ($dealerAddr ?: '—');
            $pickupPhone = $pc?->phone ?? $dealerPhone;

            $pickupLat   = $pc?->latitude  ?? optional($dealer)->latitude;
            $pickupLong  = $pc?->longitude ?? optional($dealer)->longitude;

            $pickup = [
                'name'          => $pickupName,
                'address'       => $pickupAddr,
                'city'          => $pc?->city ?? optional($dealer)->city,
                'district'      => $pc?->district ?? optional($dealer)->district,
