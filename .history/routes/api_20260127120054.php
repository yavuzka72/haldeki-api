...
use App\Http\Controllers\Api\PartnerClientAddressController;
...
Route::prefix('partner/v1')->group(function () {
    ...
    // Partner clients (public gibi bırakmışsın, aynen korudum)
    ...
    Route::post('partner-clients/{id}', [PartnerClientController::class, 'update']);
