...
Route::prefix('partner/v1')->group(function () {
    ...
    Route::middleware('partner.auth')->group(function () {
        ...
        Route::get('partner/price-changes', [PartnerPriceSyncController::class, 'changes']);

        // ✅ Sunucuda cursor oku (opsiyonel)
        Route::get('partner/price-sync-state', [PartnerPriceSyncController::class, 'state']);

        // ✅ Sunucuda cursor güncelle (opsiyonel - “ack”)
        Route::post('partner/price-sync-ack', [PartnerPriceSyncController::class, 'ack']);
