...
class DeliveryManOrderDetailResource extends JsonResource
{
    /**
     ...
     */
    public function returnOrdered()
{
    // parent_order_id’si bu siparişe bağlı alt siparişlerse:
    return $this->hasMany(DeliveryOrder::class, 'parent_order_id');
}
    ...
    public function toArray($request)
    {
        return [
            ...
            'pickup_time_signature'     =>  null,//getSingleMedia($this, 'pickup_time_signature', null),
            'delivery_time_signature'   => null,// getSingleMedia($this, 'delivery_time_signature', null),
            'auto_assign'                   => $this->auto_assign,
            'cancelled_delivery_man_ids'    => $this->cancelled_delivery_man_ids,
            'created_at'    => $this->created_at,
            'updated_at'    => $this->updated_at,
            'deleted_at' => $this->deleted_at,
            'return_order_id' => true ,// $this->retunOrdered->count() > 0 ? true : false,
            'vehicle_id' => $this->vehicle_id,
            'vehicle_data' => $this->vehicle_data,
            'vehicle_image' =>null,// getMediaFileExit(optional($this->vehicle), 'vehicle_image') ? getSingleMedia(optional($this->vehicle), 'vehicle_image', null) : null,
                  'order_photo' => $this->order_photo,
            'pick_photo' => $this->pick_photo,
            'delivery_photo' => $this->delivery_photo,
              'customer_fcm_token' => $this->customer_fcm_token,
            'deliveryman_fcm_token' => $this->deliveryman_fcm_token,
        ];
    }
}